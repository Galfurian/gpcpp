...
int main()
{
    ...
    gnuplot
        ...
        .add_label(
            5, 500, "Left", 12.0, "red", 0.0, 0.0, halign_t::left, 0.0, true,
            {true, true, "yellow", true, "gray", 1.0, 1, 1})
        .add_label(
            10, 1000, "Center", 12.0, "green", 0.0, 0.0, halign_t::center, 0.0, true,
            {true, true, "yellow", true, "gray", 1.0, 1, 1})
        .add_label(
            15, 1500, "Right", 12.0, "blue", 0.0, 0.0, halign_t::right, 0.0, true,
            {true, true, "yellow", true, "gray", 1.0, 1, 1})
        // Create the plot.
